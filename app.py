...
function sidebar(){
 ...
 <div class="sideScroll">
   ...
   <a class="sideBtn" href="/static/downloads/SpookChatPCSet-up.exe" download="VYNTRAPCSet-up.exe" style="text-decoration:none"><span class="iconBox">⬇</span>Download Desktop App</a>
...
function showMobileAccountSheet(){
 modalOpen("Your VYNTRA",`<div class="formGrid">
   ...
   <a class="ghost" href="/static/downloads/SpookChatPCSet-up.exe" download="VYNTRAPCSet-up.exe" style="text-decoration:none;text-align:center">⬇ Desktop App</a>
...
function renderSettings(){
 ...
 <div class="card"><h3>Desktop App</h3><div class="muted" style="margin-bottom:12px">Install the Windows desktop version of VYNTRA.</div><a class="primary" href="/static/downloads/SpookChatPCSet-up.exe" download="VYNTRAPCSet-up.exe" style="display:inline-block;text-decoration:none">Download VYNTRA for Windows</a></div>
